...
filename = 'coview_Autoencoder_resize_SGD'
...
def main():
    ...
    coview_val = DatasetFolder(root='../coview_data/val/', loader=numpy_loader, extensions='npz', transform=transform_train)
